/*
 * PoolExRNNClassifier.h
 *
 *  Created on: Mar 18, 2015
 *      Author: mszhang
 */

#ifndef SRC_PoolExRNNClassifier_H_
#define SRC_PoolExRNNClassifier_H_
...
public:
  ...
  inline void init(const NRMat<dtype>& wordEmb, int wordcontext, int rnnHiddenSize, int hiddensize, int labelSize) {
    ...
    _olayer_linear.initial(_labelSize, _poolsize + _gatedsize, false, 70, 2);
...
#endif /* SRC_PoolExRNNClassifier_H_ */
